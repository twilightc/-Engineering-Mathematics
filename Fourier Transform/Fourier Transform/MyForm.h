...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->methodToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::methodToolStripMenuItem_Click);
			// 
			...
			this->flowLayoutPanel1->Font = (gcnew System::Drawing::Font(L"PMingLiU", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
			...
			this->SourceImageLabel->Font = (gcnew System::Drawing::Font(L"Microsoft JhengHei", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(136)));
			...
			this->ResultImageLabel->Font = (gcnew System::Drawing::Font(L"Microsoft JhengHei", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(136)));
...
private: System::Void methodToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
...
private: System::Void lowpassFilterToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	fourierTransformMethod->LowpassFilter(dataManager->GetInputImage(), dataManager->GetOutputImage(),
										  dataManager->GetFreqReal(),dataManager->GetFreqImag(), h);
	Bitmap^ DFTImage = gcnew Bitmap(w, h);
...
private: System::Void highpassFilterToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	fourierTransformMethod->HighpassFilter(dataManager->GetInputImage(), dataManager->GetOutputImage(),
		       dataManager->GetFreqReal(), dataManager->GetFreqImag(), h);
	Bitmap^ DFTImage = gcnew Bitmap(w, h);
